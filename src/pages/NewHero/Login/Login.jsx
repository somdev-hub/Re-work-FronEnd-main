  ...
  return (
    <div className="p-4 flex h-screen ">
      <div className="flex flex-1 mt-5 flex-col mx-6 xl:mx-[7.65rem]">
        ...
        <div className="flex flex-col flex-1 justify-center">
          ...
          >
            ...
            <Link to="/forgetpassword" className="text-right cursor-pointer text-[1rem] font-poppins font-[600] text-[#5C27C0]">
              Forgot password?
            </Link>
            <button
      ...
      <div className="flex flex-col flex-1 bg-[#5C27C0] rounded-lg relative overflow-hidden">
        ...
        <p className="text-[#F5F5F5] font-poppins text-[1rem] font-[400] mt-8 xl:mt-[4rem] z-10 mx-8 xl:mx-[5rem]">
