...
const AboutUs = () => {
  ...
  return (
    <div>
      <div className="h-[80vh] 3xl:items-center 3xl:mt-0  flex flex-col items-center justify-center sm:px-0 px-[1rem]">
        <div className="text-center">
          <p className="text-[1.125rem] font-[500] font-poppins">About Us</p>
          <h1 className="2xl:text-[3.125rem] sm:text-[3.1rem] text-[2.3rem] 3xl:text-[6.5rem] font-[500] sm:leading-[5.125rem] 3xl:leading-[9rem] font-garnett-semi-bold heading-h1 py-4">
            Empowering Your Hiring Journey:
          </h1>
          <h1 className="text-[#4C4C4C] sm:text-[2.5rem] 2xl:text-[3.125rem] text-[1.5rem] 3xl:text-[4.5rem] font-400 font-garnett-regular sm:leading-[3rem] 3xl:leading-[6rem]">
            Unveiling the Rework Difference
          </h1>
          <p className="text-center text-[#353535] font-poppins font-[400] 3xl:text-[1.5rem] mt-7 3xl:mt-10">
            ...
            Matches. <br /> Your Success, Simplified.
          </p>
        </div>
        <button className="flex px-[1.5rem] py-[0.5rem] sm:px-[3rem] 2xl:px-[3.5rem] sm:py-[1.1rem] 3xl:mt-[2.5rem] heading-btn text-[#FFFBFB] font-poppins sm:text-[1.2rem] 2xl:text-[1.5rem]  text-[1rem] font-[500] mt-9">
          Get Started
        </button>
      </div>

      <div className="mx-[1.5rem] xl:mx-[7.5rem] my-[8rem] flex gap-4 flex-wrap">
        <div className="flex flex-col flex-1">
          <div className="">
            <img src={about_us_one} alt="" />
          </div>
          <p className="text-[#040404] font-garnett-medium text-[1.125rem] font-[500] mt-[1.8rem]">
            Who we are?
          </p>
          <h3 className="text-[#5C27C0] font-garnett-semi-bold text-[1.75rem] font-[600] my-4">
            We are Rework, a team dedicated to supercharging the hiring process
            through our cutting-edge A.I. technology.{" "}
          </h3>
          <p className="text-[#131313] font-poppins text-[1.125rem] font-[400]">
      ...
      <div className="bg-[#5C27C0] px-[1.5rem] xl:px-[7.5rem] py-10 xl:py-[5rem]">
        <h2 className="text-[#FCFCFC] text-[2.625rem] font-[400] font-garnett-regular text-center">
          <span className="font-[600] font-garnett-semi-bold">Our Core </span>
          values
        </h2>
        <div className="flex mt-[5rem] flex-col lg:flex-row">
          <div className="">
            <img src={core_value_one} alt="" />
            <div className="my-8">
              <h4 className="text-[#FCFCFC] font-garnett-semi-bold text-[1.5rem] font-[600]">
                Ensure-impactful
              </h4>
              <p className="text-[#FCFCFC] font-garnett-regular text-[1.5rem] font-[400]">
                Innovations
              </p>
            </div>
            <p className="text-white font-poppins font-[400]">
      ...
      <div className="my-[5rem]">
        <h2 className=" text-[2.625rem] font-[400] font-garnett-regular text-center">
          <span className="font-[600] font-garnett-semi-bold heading-h2">
            Meet Our{" "}
          </span>
          Team
        </h2>
        <div className="mx-6 xl:mx-[8rem] sm:grid md:grid-cols-3 md:grid-rows-2 sm:grid-cols-2 justify-items-center gap-[5rem] justify-center items-center mt-[4rem]">
          {team_members.map((member, index) => {
            return (
              ...
              >
                ...
                <div className="mt-6">
                  <h4 className="text-[#2C2C2C] text-[1.5rem] font-[600] font-garnett-medium text-center">
                    {member.name}
                  </h4>
                  <p className="text-[#2C2C2C] text-center font-garnett-regular text-[1.375rem] font-[400]">
                    {member.position}
                  </p>
                </div>
              </div>
      ...
      <div className="bg-[#5C27C0] px-[1.5rem] xl:px-[7.5rem] py-10 xl:py-[5rem]">
        ...
        <div className="flex gap-4 mt-[6.5rem] flex-wrap flex-col md:flex-row">
          {achievements.map((achievement, index) => {
            return (
              <div
                className="bg-[#EFE5FF] rounded-[1.25rem] py-5 px-5 flex flex-col justify-between items-center flex-1 h-[25rem]"
                key={index}
              >
                <img src={achievement.image} alt="" />
                <p className="text-[#181818] font-garnett-semi-bold text-[1.125rem] font-[600] text-center">
                  {achievement.title}
                </p>
                <h3 className="text-[#181818] text-[3.125rem] font-[700] font-space-grotesk text-center">
                  {achievement.numbers}
                </h3>
                <p className="text-[#181818] font-poppins text-[1.125rem] font-[400] text-center">
