...
const DataProtection = () => {
  ...
  return (
    <div className="mt-0 xl:mt-6">
      <div className="py-[2.3rem] bg-[#E6D7FE] px-6 xl:px-[7.5rem]">
        <h1 className="text-[#5C27C0] font-garnett-semi-bold text-[3.125rem] font-[600] m-0">
          Data Protection
        </h1>
      </div>
      <div className="bg-[#F5F0FF] px-6 xl:px-[7.31rem] py-[4rem]">
        <p className="text-[#272727] font-garnett-medium-italic text-[1.125rem] font-[600] italic mb-10">
