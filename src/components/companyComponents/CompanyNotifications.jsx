...
const CompanyNotifications = () => {
  ...
  const company_notification_update = useSelector(
    (state) => state.counter.companyNotification_update
  );
        ...
        <div className="flex">
          <div className="border rounded-full p-1.5 bg-gray-100 hover:bg-gray-200 cursor-pointer">
            ...
            <div
              ...
              } absolute z-20 top-16 right-4 w-72 max-w-96 sm:w-96 h-auto max-h-96 overflow-auto pt-1 border bg-white rounded-md shadow-md`}
            >
